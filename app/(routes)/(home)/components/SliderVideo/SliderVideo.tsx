...
export function SliderVideo() {
    return (
        <div className="relative w-full -[80vw] md:h-[56.25vw] lg:h-[45vw]">
            ...
            md:px-0 md:left-[4%] z-20 top-0 -bottom-7 md:bottom-[36%]">
                <div className="pt-24 md:pt-0">
                    ...
                    <p className="max-w-md mt-2 text-xs md:text-base">
                        Aprender a crear desde cero un clon de netflix
                        Aprender a crear desde cero un clon de netflix
                        Aprender a crear desde cero un clon de netflix
                        Aprender a crear desde cero un clon de netflix
                    </p>
                    <div className="flex flex-col md:flex-row gap-4 mt-5">
                        ...
                        <Button size="lg" className="bg-gray-500/50 hover:bg-gray-500/40">
                            <Info className="h-6 w-6 mr-2"></Info>
                            Mas información
                        </Button>
                    </div>
                </div>
            ...
            <div className="bg-transparent bg-no-repeat bg-contain w-full opacity-100 top-auto h-[14.7vw] -bottom-16
                absolute bg-gradient-video"></div>
